...
const expected=['r3d-editor.js?v=rc7','r3d-renderer.js?v=rc7','r3d-core-validation.js?v=rc7-corefix1','r3d-render-watchdog.js?v=rc7-orientfix1','r3d-input-priority-shim.js?v=rc7','r3d-local-orbit.js?v=rc7','r3d-camera-gizmos.js?v=rc7','r3d-gi-extension.js?v=rc7-gi1','r3d-render-window.js?v=rc7-debug1','r3d-bootstrap.js?v=rc7'];
...
console.log(`staticIDs=${ids.length} scripts=${scripts.length} renderWindow=${rw.length} watchdogBasis=canonical coreValidation=clean-webgpu-retry gi=ray-color-bounce+ao debug=render-timeline+copy`);