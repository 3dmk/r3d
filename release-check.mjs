...
const files=['index.html','r3d-editor.js','r3d-renderer.js','r3d-core-validation.js','r3d-render-watchdog.js','r3d-feature-rays.js','r3d-input-priority-shim.js','r3d-local-orbit.js','r3d-camera-gizmos.js','r3d-gi-extension.js','r3d-luma-quality.js','r3d-render-window.js','r3d-bootstrap.js'];
...
const expected=['r3d-editor.js?v=rc7','r3d-renderer.js?v=rc7','r3d-core-validation.js?v=rc7-corefix1','r3d-render-watchdog.js?v=rc7-orientfix1','r3d-feature-rays.js?v=rc7-feature1','r3d-input-priority-shim.js?v=rc7','r3d-local-orbit.js?v=rc7','r3d-camera-gizmos.js?v=rc7','r3d-gi-extension.js?v=rc7-gi5','r3d-luma-quality.js?v=rc7-luma2','r3d-render-window.js?v=rc7-debug1','r3d-bootstrap.js?v=rc7'];
...
const ed=read('r3d-editor.js'),ren=read('r3d-renderer.js'),core=read('r3d-core-validation.js'),watch=read('r3d-render-watchdog.js'),feature=read('r3d-feature-rays.js'),priority=read('r3d-input-priority-shim.js'),orbit=read('r3d-local-orbit.js'),cams=read('r3d-camera-gizmos.js'),gi=read('r3d-gi-extension.js'),lq=read('r3d-luma-quality.js'),rw=read('r3d-render-window.js'),boot=read('r3d-bootstrap.js');
...
console.log(`staticIDs=${ids.length} scripts=${scripts.length} renderWindow=${rw.length} watchdogBasis=canonical coreValidation=clean-webgpu-retry featureRays=selective-fullres-budget gi=edge-locked-polarity-confidence-HQ luma=polarity-aware-anti-bleed debug=render-timeline+copy giMutableColor=verified`);