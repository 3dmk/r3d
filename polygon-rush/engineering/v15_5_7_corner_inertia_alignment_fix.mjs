...
s=s.replace('throttleRise:3.4, throttleFall:5.8, accelWeight:.58, steerCurve:1.72, steerCenter:5.4,',
            'throttleRise:3.4, throttleFall:5.8, accelWeight:.58, steerCurve:1.72, steerCenter:5.4, cornerInertia:.72, tireAlign:8.6, alignRelease:9.8,');
...
for(const r of ['Polygon Rush v15.5.7 Corner Inertia + Alignment Fix','cornerInertia:.72','tireAlign:8.6','alignRelease:9.8','const cornerAccel=-long*car.yawRate','testCornerInertia:()=>'])must(s.includes(r),'v15.5.7 missing '+r);
