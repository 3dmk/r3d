...
for(const r of ['Polygon Rush v15.5.17 Corner Drive + Steering Response','yawInertiaScale:1.12','cornerCombinedGrip:1.34','drivenLongPriority:.95','steeringDriveAssist:.24','cornerMomentumAssist:.16','steeringYawRelease:2.4','rackRate=12.6','requestedLong','reservedLong','steerMomentum=clamp(Math.abs(rawSteer)*car._driveThrottle','testCornerDriveResponse:()=>'])must(s.includes(r),'v15.5.17 missing '+r);
fs.writeFileSync(file,s);
console.log('Polygon Rush v15.5.17 corner momentum hotfix applied');
